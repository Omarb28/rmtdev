    ...
    return (
      <>
        <section className="job-details">
          <div>
            {isLoadingDetails ? <Spinner /> : null}

            {!isLoadingDetails && (
              <FullJobContent jobItemDetails={jobItemDetails} />
            )}
          </div>
        </section>
      </>
...
type FullJobContentProps = {
  jobItemDetails: TJobItemDetails;
};

function FullJobContent({ jobItemDetails }: FullJobContentProps) {
  return (
    <>
      <img
      ...
      <section className="job-info">
        ...
        <div className="job-info__right">
          ...
          <p className="job-info__description">{jobItemDetails.description}</p>
